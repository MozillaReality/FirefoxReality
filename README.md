...
Create a file called `user.properties` in the top-level project directory. Add a variable called `geckoViewLocalTopsrcdir` and, optionally, `geckoViewLocalTopobjdir` and set them to your local mozilla-central topsrcdir and topobjdir, respectively:

```ini
geckoViewLocalTopsrcdir=/path/to/your/topsrcdir
geckoViewLocalTopobjdir=/path/to/your/topobjdir
```
