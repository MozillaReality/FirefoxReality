...
public class EnvironmentUtils {
    ...
    private static final String ENVS_FOLDER = "envs";
    private static final String BUILTIN_ENVS_PREFIX = "cubemap/";
     ...
     */
    @Nullable
    private static String getExternalEnvPath(@NonNull Context context, @NonNull String envId) {
     ...
     */
    @NonNull
    private static String getBuiltinEnvPath(@NonNull String envId) {
    ...
    public static Environment[] getExternalEnvironments(@NonNull Context context) {
        ...
        if (properties != null) {
            ...
            if (properties.containsKey(BuildConfig.VERSION_NAME)) {
                RemoteProperties versionProperties = properties.get(BuildConfig.VERSION_NAME);
